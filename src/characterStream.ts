...
export class CharacterStream {
	 ...
	 * Does not consume
	 * @param comparison The character to search for, or a function that takes a CharacterStream and returns a boolean
	 * @returns The index of the character if found. Otherwise false
	 */
	seek(comparison: string | ((s: CharacterStream) => boolean), max?: number): number | undefined {
